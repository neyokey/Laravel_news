            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding ">
                    <form enctype="multipart/form-data" method="post" accept-charset="utf-8" 
                        class="form-horizontal" action="<?= url('/admin/usertype/edit/'.$usertype[0]->id); ?>">
                        @csrf
                        ...
                        <div class="control-group ">
                            ...
                            <div class="controls">
                                <div class="input text required">
                                    <input type="text" name="name" class="span6" value="<?= $usertype[0]->name?>" required="required" maxlength="50" id="name" />
                                </div>
                            </div>
                        </div>
