...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="img/front/core-img/favicon.ico">
            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="vizewNav">
                        ...
                        <!-- Nav brand -->
                        <a href="index.html" class="nav-brand"><img src="img/front/core-img/logo.png" alt=""></a>
                ...
                <div class="col-12 col-md-7 col-lg-8">
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="post-1" role="tabpanel" aria-labelledby="post-1-tab">
                            <!-- Single Feature Post -->
                            <div class="single-feature-post video-post bg-img" style="background-image: url(img/front/bg-img/7.jpg);">
                                <!-- Play Button -->
                        ...
                        <div class="tab-pane fade" id="post-2" role="tabpanel" aria-labelledby="post-2-tab">
                            <!-- Single Feature Post -->
                            <div class="single-feature-post video-post bg-img" style="background-image: url(img/front/bg-img/8.jpg);">
                                <!-- Play Button -->
                                <a href="video-post.html" class="btn play-btn"><i class="fa fa-play" aria-hidden="true"></i></a>
                        ...
                        <div class="tab-pane fade" id="post-3" role="tabpanel" aria-labelledby="post-3-tab">
                            <!-- Single Feature Post -->
                            <div class="single-feature-post video-post bg-img" style="background-image: url(img/front/bg-img/9.jpg);">
                                <!-- Play Button -->
                                <a href="video-post.html" class="btn play-btn"><i class="fa fa-play" aria-hidden="true"></i></a>
                        ...
                        <div class="tab-pane fade" id="post-4" role="tabpanel" aria-labelledby="post-4-tab">
                            <!-- Single Feature Post -->
                            <div class="single-feature-post video-post bg-img" style="background-image: url(img/front/bg-img/10.jpg);">
                                <!-- Play Button -->
                                <a href="video-post.html" class="btn play-btn"><i class="fa fa-play" aria-hidden="true"></i></a>
                    ...
                    <ul class="nav vizew-nav-tab" role="tablist">
                            ...
                            <a class="nav-link active" id="post-1-tab" data-toggle="pill" href="#post-1" role="tab" aria-controls="post-1" aria-selected="true">
                                ...
                                <div class="single-blog-post style-2 d-flex align-items-center">
                                    <div class="post-thumbnail">
                                        <img src="img/front/bg-img/3.jpg" alt="">
                                    </div>
                                    <div class="post-content">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="post-2-tab" data-toggle="pill" href="#post-2" role="tab" aria-controls="post-2" aria-selected="false">
                                ...
                                <div class="single-blog-post style-2 d-flex align-items-center">
                                    <div class="post-thumbnail">
                                        <img src="img/front/bg-img/4.jpg" alt="">
                                    </div>
                                    <div class="post-content">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="post-3-tab" data-toggle="pill" href="#post-3" role="tab" aria-controls="post-3" aria-selected="false">
                                ...
                                <div class="single-blog-post style-2 d-flex align-items-center">
                                    <div class="post-thumbnail">
                                        <img src="img/front/bg-img/5.jpg" alt="">
                                    </div>
                                    <div class="post-content">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="post-4-tab" data-toggle="pill" href="#post-4" role="tab" aria-controls="post-4" aria-selected="false">
                                ...
                                <div class="single-blog-post style-2 d-flex align-items-center">
                                    <div class="post-thumbnail">
                                        <img src="img/front/bg-img/6.jpg" alt="">
                                    </div>
                                    <div class="post-content">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4">
                    <div class="single-post-area mb-80">
                        <!-- Post Thumbnail -->
                        <div class="post-thumbnail">
                            <img src="img/front/bg-img/11.jpg" alt="">
                ...
                <div class="col-12 col-md-4">
                    <div class="single-post-area mb-80">
                        <!-- Post Thumbnail -->
                        <div class="post-thumbnail">
                            <img src="img/front/bg-img/12.jpg" alt="">
                ...
                <div class="col-12 col-md-4">
                    <div class="single-post-area mb-80">
                        <!-- Post Thumbnail -->
                        <div class="post-thumbnail">
                            <img src="img/front/bg-img/13.jpg" alt="">
                ...
                <div class="col-12 col-md-7 col-lg-8">
                    <div class="all-posts-area">
                        ...
                        <div class="featured-post-slides owl-carousel mb-30">
                            <!-- Single Feature Post -->
                            <div class="single-feature-post video-post bg-img" style="background-image: url(img/front/bg-img/14.jpg);">
                                <!-- Play Button -->
                                <a href="video-post.html" class="btn play-btn"><i class="fa fa-play" aria-hidden="true"></i></a>
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                <div class="sport-video-slides owl-carousel mb-50">
                                    ...
                                    <div class="single-post-area">
                                        <!-- Post Thumbnail -->
                                        <div class="post-thumbnail">
                                            <img src="img/front/bg-img/15.jpg" alt="">
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                <div class="business-video-slides owl-carousel mb-50">
                                    ...
                                    <div class="single-post-area">
                                        <!-- Post Thumbnail -->
                                        <div class="post-thumbnail">
                                            <img src="img/front/bg-img/17.jpg" alt="">
                        ...
                        <div class="single-post-area mb-30">
                            <div class="row align-items-center">
                                <div class="col-12 col-lg-6">
                                    <!-- Post Thumbnail -->
                                    <div class="post-thumbnail">
                                        <img src="img/front/bg-img/21.jpg" alt="">
                        ...
                        <div class="single-post-area mb-30">
                            <div class="row align-items-center">
                                <div class="col-12 col-lg-6">
                                    <!-- Post Thumbnail -->
                                    <div class="post-thumbnail">
                                        <img src="img/front/bg-img/22.jpg" alt="">
                        ...
                        <div class="single-post-area mb-30">
                            <div class="row align-items-center">
                                <div class="col-12 col-lg-6">
                                    <!-- Post Thumbnail -->
                                    <div class="post-thumbnail">
                                        <img src="img/front/bg-img/23.jpg" alt="">
                        ...
                        <div class="single-post-area mb-30">
                            <div class="row align-items-center">
                                <div class="col-12 col-lg-6">
                                    <!-- Post Thumbnail -->
                                    <div class="post-thumbnail">
                                        <img src="img/front/bg-img/24.jpg" alt="">
                ...
                <div class="col-12 col-md-5 col-lg-4">
                    <div class="sidebar-area">
                        ...
                        <div class="single-widget latest-video-widget mb-50">
                            ...
                            <div class="single-blog-post d-flex">
                                <div class="post-thumbnail">
                                    <img src="img/front/bg-img/35.jpg" alt="">
                                </div>
                                <div class="post-content">
                        ...
                        <div class="single-widget add-widget mb-50">
                            <a href="#"><img src="img/front/bg-img/add.png" alt=""></a>
                        </div>
                        ...
                        <div class="single-widget youtube-channel-widget mb-50">
                            ...
                            <div class="single-youtube-channel d-flex align-items-center">
                                <div class="youtube-channel-thumbnail">
                                    <img src="img/front/bg-img/25.jpg" alt="">
                                </div>
                            ...
                            <div class="single-youtube-channel d-flex align-items-center">
                                <div class="youtube-channel-thumbnail">
                                    <img src="img/front/bg-img/26.jpg" alt="">
                                </div>
                                <div class="youtube-channel-content">
                            ...
                            <div class="single-youtube-channel d-flex align-items-center">
                                <div class="youtube-channel-thumbnail">
                                    <img src="img/front/bg-img/27.jpg" alt="">
                                </div>
                                <div class="youtube-channel-content">
                            ...
                            <div class="single-youtube-channel d-flex align-items-center">
                                <div class="youtube-channel-thumbnail">
                                    <img src="img/front/bg-img/28.jpg" alt="">
                                </div>
                                <div class="youtube-channel-content">
                            ...
                            <div class="single-youtube-channel d-flex align-items-center">
                                <div class="youtube-channel-thumbnail">
                                    <img src="img/front/bg-img/29.jpg" alt="">
                                </div>
                                <div class="youtube-channel-content">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="footer-widget mb-70">
                        <!-- Logo -->
                        <a href="index.html" class="foo-logo d-block mb-4"><img src="img/front/core-img/logo2.png" alt=""></a>
