                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="breaking-news-area d-flex align-items-center">
                                ...
                                <div id="breakingNewsTicker" class="ticker">
                                    <ul>
                                        <li><a href="single_post">10 Things Amazon Echo Can Do</a></li>
                                        <li><a href="single_post">Welcome to Colorlib Family.</a></li>
                                        <li><a href="single_post">Boys 'doing well' after Thai</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="footer-widget mb-70">
                            ...
                            <div class="single-blog-post d-flex">
                                ...
                                <div class="post-content">
                                    <a href="single_post" class="post-title">DC Shoes: gymkhana the</a>
                            ...
                            <div class="single-blog-post d-flex">
                                ...
                                <div class="post-content">
                                    <a href="single_post" class="post-title">Sweet Yummy Chocolatea Tea</a>
                                    <div class="post-meta d-flex justify-content-between">
                                        <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> 14</a>
                                        <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 34</a>
                                        <a href="#"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> 84</a>
